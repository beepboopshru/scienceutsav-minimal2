...
const ROLE_DEFAULTS: Record<string, Record<PermissionResource, Record<string, boolean>>> = {
  ...
  sales: {
    ...
    discrepancyTickets: { view: true, create: true, edit: true, resolve: false, delete: false },
  ...
  laser_operator: {
    ...
    laserFiles: { view: true, upload: true, delete: false },
  ...
  operations: {
    ...
    assignments: { view: true, create: false, edit: true, delete: false, updateStatus: true },
    inventory: { view: true, create: true, edit: true, delete: false, editStock: true, createCategories: true, importData: true },
    ...
    billTracking: { view: false, create: false, edit: false, updateStatus: false, delete: false },
    vendorImports: { view: true, create: true, edit: false, updatePaymentStatus: false, delete: false },
    orderHistory: { view: true, export: false },
    laserFiles: { view: false, upload: false, delete: false },
    reports: { view: true, download: true },
    adminZone: { view: false, clearAssignments: false, viewActivityLogs: false, deleteActivityLogs: false },
