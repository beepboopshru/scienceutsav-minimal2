...
import { CheckCircle2, Edit2, Loader2, Plus, Trash2, CalendarIcon, Check, X, Save, FileText, MessageSquare, Truck, ChevronUp, ChevronDown } from "lucide-react";
...
export default function B2BAssignments() {
  ...
  const [importedClient, setImportedClient] = useState<any>(null);
      ...
      <div className="container mx-auto py-6 space-y-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleStartBatch} className="gap-2">
              <Plus className="h-4 w-4" />
              Start Batch
            </Button>
            <Button onClick={handleAddNewRow} variant="outline" disabled={isAddingNewRow || batchesInProgress.length > 0}>
                                    ...
                                    <div className="font-medium">
                                      {typeof assignment.clientId === "string"
                                        ? clients?.find((c) => c._id === assignment.clientId)?.organization || 
                                          clients?.find((c) => c._id === assignment.clientId)?.name || "Unknown"
                                        : "Unknown"}
                                    </div>
                                  </TableCell>
                    ...
                    >
                      ...
                      {editingAssignmentId === assignment._id ? (
                        ...
                        <>
                          ...
                          <TableCell>
                            <div className="font-medium">
                              {typeof assignment.client === 'object' && assignment.client && 'organization' in assignment.client
                                ? assignment.client.organization || (assignment.client as any).name
                                : "Unknown"}
                            </div>
                          </TableCell>
                          <TableCell>{assignment.quantity}</TableCell>
