...
type PermissionResource = 
  ...
  | "kitStatistics" | "lms" | "materialRequests" | "packingRequests";
...
const ROLE_DEFAULTS: Record<string, Record<PermissionResource, Record<string, boolean>>> = {
  ...
  finance: {
    ...
    inventory: { view: true, create: false, edit: false, delete: false, editStock: false, createCategories: false, importData: false, editBOM: false },
  ...
  operations: {
    ...
    inventory: { view: true, create: true, edit: true, delete: false, editStock: true, createCategories: false, importData: true, editBOM: true },
    vendors: { view: true, create: false, edit: false, delete: false },
    services: { view: false, create: false, edit: false, delete: false },
